...
import {
  Github, Mail, GraduationCap, Gamepad2, BookOpenText, ShieldHalf, Sparkles,
  ExternalLink, Link as LinkIcon, Cpu, Braces, GraduationCap as GraduationCapIcon
} from 'lucide-react'
...
export default function App() {
  return (
    <main className="theme-invert min-h-screen bg-gradient-to-b from-white via-white to-black/[.03] dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-950 text-foreground relative overflow-hidden">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight">
              ...
              <span className="bg-gradient-to-r from-indigo-500 to-emerald-500 bg-clip-text text-transparent preserve-gradient">
                calm
              </span>
              ,<br className="hidden sm:block" />
              <span className="bg-gradient-to-r from-fuchsia-500 to-sky-500 bg-clip-text text-transparent preserve-gradient">
                safe
              </span>
              , and joyful.
            </h1>
            <p className="mt-4 text-lg text-black/70 dark:text-white/80">
              I research <span className="font-medium text-foreground">autism & social media</span> and design sensory-aware interfaces to
              reduce overload and anxiety. I also build friendly tools like the
              <a className="inline-flex items-center gap-1 ml-1 underline" href="https://socialmediaacademy.click/" target="_blank" rel="noreferrer">
                Social Media Academy <ExternalLink className="h-4 w-4" />
              </a>
              and a playful{' '}
              <a className="inline-flex items-center gap-1 underline" href="https://socialmediaacademy.click/play" target="_blank" rel="noreferrer">
                Rock-Paper-Scissors simulation <Gamepad2 className="h-4 w-4" />
              </a>.
            </p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium text-black/60 dark:text-white/70">
                <GraduationCap className="h-4 w-4 mr-1" /> BYU CS
              </span>
              <span className="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium text-black/60 dark:text-white/70">
                GPA 3.54
              </span>
              <span className="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium text-black/60 dark:text-white/70">
                <Cpu className="h-4 w-4 mr-1" /> Full-stack / HCI
              </span>
              <span className="inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium text-black/60 dark:text-white/70">
                <Sparkles className="h-4 w-4 mr-1" /> Research + Build
              </span>
            </div>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#previews">
                <Button size="lg" className="rounded-2xl">
                  <Gamepad2 className="mr-2 h-5 w-5" /> See Live Previews
                </Button>
              </a>
              <a href="#research">
                <Button variant="outline" size="lg" className="rounded-2xl">
                  <BookOpenText className="mr-2 h-5 w-5" /> Read Research
                </Button>
              </a>
            </div>
          </motion.div>

          {/* Quick Facts (replaces old Safe Board hero card) */}
            ...
            <Card className="rounded-2xl shadow-card overflow-hidden">
              ...
              <CardContent className="space-y-3 text-sm text-black/70 dark:text-white/80">
                ...
                <div className="flex flex-wrap gap-3 pt-1">
                  ...
                  <a href="mailto:steven.chengvaie@gmail.com">
                    <Button variant="outline" className="rounded-2xl">Email</Button>
                  </a>
                </div>
              </CardContent>
            </Card>
      ...
      <Section
        id="research"
        title="Research: Autism x Social Media"
        subtitle="Insights from experiments, prototypes, and literature on reducing sensory and social stressors online."
      >
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Card className="h-full rounded-2xl">
              ...
              <CardContent className="space-y-3 text-sm text-black/70 dark:text-white/80">
                <p>
                  The idea started when I noticed many autistic users struggle to use social media “correctly” — complex interfaces,
                  information overload, and unfamiliar jargon can quickly lead to anxiety or confusion. Then I realized it’s not just
                  them: people from different cultural backgrounds, parents helping their kids, older adults, and even some younger
                  users also need guidance.
                </p>
                <p>
                  Social Media Academy is my attempt to help everyone understand platforms in plain language and learn safer, healthier
                  habits — from basic features and settings, to common internet slang, to privacy and emotion management tips. It’s not
                  a one-time tutorial, but a friendly guide you can return to anytime.
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Card className="h-full rounded-2xl">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <a href="https://socialmediaacademy.click/" target="_blank" rel="noreferrer">
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <p className="text-black/70 dark:text-white/80">
                  Guides for safer, kinder social media; plain-language explanations of features & internet slang.
                </p>
                ...
                <p className="text-black/70 dark:text-white/80">
                  A tiny physics-style canvas toy to decompress—watch emojis collide and evolve.
                </p>
              </CardContent>
            </Card>
          </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="rounded-2xl overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="flex items-center gap-2">
                  <BookOpenText className="h-5 w-5" /> Social Media Academy
                </CardTitle>
                <a href="https://socialmediaacademy.click/" target="_blank" rel="noreferrer">
                  <Button variant="outline" size="sm" className="rounded-2xl">
                    Open <ExternalLink className="ml-1 h-4 w-4" />
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Card className="rounded-2xl overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="flex items-center gap-2">
                  <Gamepad2 className="h-5 w-5" /> RPS Particle Simulation
                </CardTitle>
                <a href="https://socialmediaacademy.click/play" target="_blank" rel="noreferrer">
                  <Button variant="outline" size="sm" className="rounded-2xl">
                    Open <ExternalLink className="ml-1 h-4 w-4" />
                  </Button>
                </a>
      ...
      <Section
        id="about"
        title="About"
        subtitle="Brigham Young University · B.S. Computer Science (May 2026). I research autism × social media and build human-centered interfaces."
      >
        <div className="grid gap-6 md:grid-cols-2">
      ...
      <Section id="contact" title="Contact" subtitle="Let's build helpful, human-centered tools together.">
        <div className="flex flex-wrap items-center gap-3">
          <a href="/resume.pdf" download>
            <Button size="lg" className="rounded-2xl">Download Resume</Button>
          </a>
          <a href="mailto:steven.chengvaie@gmail.com">
            <Button size="lg" className="rounded-2xl">
          ...
          <a href="https://github.com/StevenChengCCC/" target="_blank" rel="noreferrer">
          ...
          <a href="#home">
            <Button size="lg" variant="ghost" className="rounded-2xl">
              <LinkIcon className="mr-2 h-5 w-5" /> Back to top
            </Button>
          </a>
        </div>
      </Section>
